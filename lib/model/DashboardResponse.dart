class DashboardResponse {
  ...
  List<DashboardBookInfo>? suggestedForYou;
  List<DashboardBookInfo>? youMayLike;
  List<DashboardBookInfo>? featured;
  List<DashboardBookInfo>? newest;
  ...
  DashboardResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (json['suggested_for_you'] != null) {
      suggestedForYou = <DashboardBookInfo>[];
      json['suggested_for_you'].forEach((v) {
        suggestedForYou!.add(new DashboardBookInfo.fromJson(v));
      });
    }
    ...
    if (json['you_may_like'] != null) {
      youMayLike = <DashboardBookInfo>[];
      json['you_may_like'].forEach((v) {
        youMayLike!.add(new DashboardBookInfo.fromJson(v));
      });
    }
    if (json['featured'] != null) {
      featured = <DashboardBookInfo>[];
      json['featured'].forEach((v) {
        featured!.add(new DashboardBookInfo.fromJson(v));
      });
    }
    if (json['newest'] != null) {
      newest = <DashboardBookInfo>[];
      json['newest'].forEach((v) {
        newest!.add(new DashboardBookInfo.fromJson(v));
      });
    }
  }
...
class Category {
  ...
  Category.fromJson(Map<String, dynamic> json) {
    ...
    if (json['product'] != null) {
      product = <DashboardBookInfo>[];
      json['product'].forEach((v) {
        product!.add(new DashboardBookInfo.fromJson(v));
      });
    }
    image = json['image'];
  }
